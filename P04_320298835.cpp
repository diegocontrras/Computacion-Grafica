...
int main()
{
	...
	*/
	...
	//rotación alrededor de la articulación que une con la cabina
		...
		//Ejercicio: Terminar el brazo y dibujar también la canasta
		...
		model = modelaux2;
		model = glm::translate(model, glm::vec3(-1.8f, -3.3f, 0.9f));
		...
		*/
		...
		modelaux4 = model;
		modelaux5 = model;
		model = glm::scale(model, glm::vec3(7.0f, 3.0f, 4.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(4.0f, 5.9f, -4.0));
		modelaux = model;
		modelaux2 = model;
		model = glm::scale(model, glm::vec3(3.0f, 3.0f, 3.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(6.0f, 5.5f, -4.0));
		modelaux = model;
		modelaux2 = model;
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(-4.0f, -1.2f, 1.0f));
		...
		modelaux = model;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::translate(model, glm::vec3(0.0f, -0.1f, 1.0));
		...
		model = modelaux2;
		model = glm::translate(model, glm::vec3(-8.0f, -1.2f, 1.0f));
		model = glm::scale(model, glm::vec3(0.7f, 0.7f, 0.7f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 1.0f, 1.0f);
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(4.0f, 8.0f, -5.0));
		modelaux = model;
		modelaux2 = model;
		model = glm::scale(model, glm::vec3(1.0f, 2.0f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(4.0f, 8.0f, -2.0));
		modelaux = model;
		modelaux2 = model;
		model = glm::scale(model, glm::vec3(1.0f, 2.0f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
